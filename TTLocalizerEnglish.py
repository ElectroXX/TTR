...
ProductPrefix = 'TT'
Mickey = 'Micky'
VampireMickey = 'VampireMicky'
Minnie = 'Minni'
WitchMinnie = 'WitchMinni'
Donald = 'Donald'
...
lYes = 'Ja'
lNo = 'Nein'
sleep_auto_reply = '%s ist gerade am Schlafen.'
lHQOfficerF = 'HQ Angestellte'
lHQOfficerM = 'HQ Angestellter'
...
ACog = 'ein Bot'
TheCogs = 'Die Bots'
ASkeleton = 'ein Skelebot'
Skeleton = 'Skelebot'
SkeletonP = 'Skelebots'
Av2Cog = 'ein Version 2.0 Bot'
v2Cog = 'Version 2.0 Bot'
v2CogP = 'Version 2.0 Bots'
ASkeleton = 'ein SkeleBot'
Foreman = 'Fabrik Vorarbeiter'
ForemanP = 'Fabrik Vorarbeiter'
AForeman = 'ein Fabrik Vorarbeiter'
CogVP = Cog + ' V.P.'
CogVPs = "Bot V.P.s"
ACogVP = ACog + ' V.P.'
Supervisor = 'Oberaufseher'
SupervisorP = 'Oberaufseher'
ASupervisor = 'ein Oberaufseher'
CogCFO = Cog + ' Schatzmeister'
CogCFOs = "Bot Schatzmeister"
ACogCFO = ACog + ' Schatzmeister'
TheFish = 'die Fische'
AFish = 'ein Fisch'
Level = 'Level'
QuestsCompleteString = 'Komplett'
QuestsNotChosenString = 'Nicht ausgewählt'
Period = '.'
#Laff = 'Lachpunkte'
QuestInLocationString = ' %(inPhrase)s %(location)s'
QuestsDefaultGreeting = ('Hallo, _avName_!', 'Hi, _avName_!', 'Grüß\' dich, _avName_!', 'Grüß\' dich, _avName_!', 'Willkommen, _avName_!', 'Howdy, _avName_!', 'Wie geht es dir, _avName_?', 'Servus _avName_!')
QuestsDefaultIncomplete = ("Wie geht es dir mit deiner Aufgabe, _avName_?", 'Sieht so aus, als ob du noch einige Arbeit in deine Aufgabe stecken musst!', 'Weiter so, _avName_!', 'Versuche weiterhin die Aufgabe fertigzustellen.  Ich weiß, dass du es tun kannst!', 'Versuche weiterhin die Aufgabe fertigzustellen, wir zählen auf dich!', 'Versuche weiterhin die Aufgabe fertigzustellen!')
QuestsDefaultIncompleteProgress = ('Du bist am rechten Platz, aber du musst deine Aufgabe erst vervollständigen.', 'Komm wieder zurück, wenn du mit deiner Aufgabe fertig bist.', 'Komm zurück, wenn du mit deiner Aufgabe fertig bist.')
QuestsDefaultIncompleteWrongNPC = ('Nette Arbeit mit deiner Aufgabe. Du solltest _toNpcName_._where_ besuchen.', 'Sieht so aus, als ob du mit deiner Aufgabe fertig bist. Geh _toNpcName_._where_ besuchen.', 'Geh zu _toNpcName_ um deine Aufgabe zu vervollständigen._where_')
QuestsDefaultComplete = ('Nette Arbeit! Hier ist deine Belohnung...', 'Großartige Arbeit, _avName_! Nimm diese Belohnung...', 'Wundervolle Arbeit, _avName_! Hier ist deine Belohnung...')
QuestsDefaultLeaving = ('Tschüss!', 'Wiedersehen!', 'Bis dann, _avName_.', 'Bis später, _avName_!', 'Viel Glück!', 'Viel Spaß in Toontown!', 'Bis später!')
QuestsDefaultReject = ('Hallo.', 'Kann ich dir helfen?', 'Wie geht es dir?', 'Grüß\' dich.', "Ich bin ein bisschen beschäftigt, _avName_.", 'Ja?', 'Howdy, _avName_!', 'Willkommen, _avName_!', "Hey, _avName_! Wie geht's voran?", 'Wusstest du, dass du dein Stickerbuch mit F8 öffnen kannst?', 'Du kannst die Karte benutzen, um dich zum Spielplatz zurück zu teleportieren!', 'Du kannst dich mit anderen Toons befreunden, indem du auf ihren Namen klickst.', 'Du kannst mehr über einen ' + Cog + ' erfahren, indem du auf ihn klickst.', 'Sammle Schätze am Spielplatz, um deine Lachpunkte wieder auf zu füllen.', Cog + 'gebäude sind gefährliche Plätze! Geh da nicht alleine rein!', 'Wenn du einen Kampf verlierst, nehmen dir die ' + Cogs + ' all deine Gags weg.', 'Um mehr Gags zu bekommen, spiel einfach im Toon-Express!', 'Du kannst dir mehr Lachpunkte verdienen, indem du Aufgaben erledigst.', 'Jede Aufgabe gibt dir eine Belohnung.', 'Einige Belohnungen lassen dich mehr Gags tragen..', 'Wenn du einen Kampf gewinnst, bekommst du für jeden ' + Cog + ' einen Fortschritt in deiner Aufgabe.', 'Wenn du ein ' + Cog + 'gebäude zurückeroberst, kannst du dir ein spezielles Dankeschön in seinem Haus ansehen!', 'Wenn du den \'Bild hoch\'-Knopf drückst, kannst du nach oben sehen!', 'Wenn du die Tabulatoren-Taste klickst, kannst du dir verschiedene Perspektiven deiner Umgebung ansehen!', "Um deinen Freunden zu zeigen, was du gerade denkst, gib einfach einen '.' vor deinem Satz ein.", 'Wenn ein ' + Cog + ' betäubt ist, ist es schwieriger, Fallen Lassen Gags auszuweichen.', 'Jede Art von ' + Cog + 'gebäuden hat ein spezifisches Aussehen.', 'Das Zerstören von ' + Cogs + ' in höheren Stockwerken gibt dir eine höhere Erfahrungsbelohnung.')
QuestsDefaultTierNotDone = ('Hallo, _avName_! Du musst deine Aufgabe erledigen, bevor du dir eine neue holen kannst.', 'Na hallo! Du musst deine Aufgabe erledigen, bevor du dir eine neue holen kannst.', 'Hi, _avName_! Du musst deine Aufgabe erledigen, bevor du dir eine neue holen kannst.')
QuestsDefaultQuest = None
QuestsDefaultVisitQuestDialog = ('Ich hab gehört, dass _toNpcName_ nach dir sucht._where_', 'Wenn du die Chance dazu hast, bei _toNpcName_ vorbeizuschauen, bekommst du eine Belohnung._where_')
QuestsLocationArticle = ''
QuestsItemNameAndNum = '%(num)s %(name)s'
QuestsCogQuestProgress = '%(progress)s von %(numCogs)s zerstört'
QuestsCogQuestHeadline = 'GESUCHT'
QuestsCogQuestSCStringS = 'Ich muss %(cogName)s%(cogLoc)s zerstören.'
QuestsCogQuestSCStringP = 'Ein muss ein paar %(cogName)s%(cogLoc)s zerstören.'
QuestsCogQuestDefeat = 'Zerstöre %s'
QuestsCogQuestDefeatDesc = '%(numCogs)s %(cogName)s'
QuestsCogNewNewbieQuestObjective = 'Helfe einem neuen Toon %s zu zestören'
QuestsCogNewNewbieQuestCaption = 'Helfe einem neuen Toon unter %d Lachpunkte'
QuestsCogOldNewbieQuestObjective = 'Helfe einem neuen Toon unter %(laffPoints)d Lachpunkten, %(objective)s zu zestören'
QuestsCogOldNewbieQuestCaption = 'Helfe einem neuen Toon unter %d Lachpunkte'
QuestsCogNewbieQuestAux = 'Zerstöre:'
QuestsNewbieQuestHeadline = 'AUSBILDUNG'
QuestsCogTrackQuestProgress = '%(progress)s von %(numCogs)s zerstört'
QuestsCogTrackQuestHeadline = 'GESUCHT'
QuestsCogTrackQuestSCStringS = 'Ich muss %(cogName)s%(cogLoc)s zerstören.'
QuestsCogTrackQuestSCStringP = 'Ein muss ein paar %(cogName)s%(cogLoc)s zerstören.'
QuestsCogTrackQuestDefeat = 'Zerstöre %s'
QuestsCogTrackDefeatDesc = '%(numCogs)s %(trackName)s'
QuestsCogLevelQuestProgress = '%(progress)s von %(numCogs)s zestört'
QuestsCogLevelQuestHeadline = 'GESUCHT'
QuestsCogLevelQuestDefeat = 'Zerstöre %s'
QuestsCogLevelQuestDesc = 'einen Level %(level)s+ %(name)s'
QuestsCogLevelQuestDescC = '%(count)s Level %(level)s+ %(name)s'
QuestsCogLevelQuestDescI = 'einige Level %(level)s+ %(name)s'
QuestsCogLevelQuestSCString = 'Ich muss %(objective)s%(location)s. zerstören.'
...
QuestsBuildingQuestHeadline = 'ZERSTÖRE'
QuestsBuildingQuestProgressString = '%(progress)s von %(num)s zerstört.'
QuestsBuildingQuestString = 'Zerstöre %s'
QuestsBuildingQuestSCString = 'Ich muss %(objective)s%(location)s. zerstören.'
...
QuestsFactoryQuestHeadline = 'ZERSTÖRE'
QuestsFactoryQuestProgressString = '%(progress)s von %(num)s zerstört'
QuestsFactoryQuestString = 'Zerstöre %s'
QuestsFactoryQuestSCString = 'Ich muss %(objective)s%(location)s zerstören.'
...
QuestsMintQuestHeadline = 'ZERSTÖRE'
QuestsMintQuestProgressString = '%(progress)s von %(num)s zerstört'
QuestsMintQuestString = 'Zerstöre %s'
QuestsMintQuestSCString = 'Ich muss %(objective)s%(location)s zerstören.'
...
QuestsRescueQuestHeadline = 'RETTE'
QuestsRescueQuestSCStringS = 'Ich muss einen Toon retten%(toonLoc)s.'
QuestsRescueQuestSCStringP = 'Ich muss einige Toons retten%(toonLoc)s.'
QuestsRescueQuestRescue = 'Rette %s'
QuestsRescueQuestRescueDesc = '%(numToons)s Toons'
QuestsRescueQuestToonS = 'einen Toon'
QuestsRescueQuestToonP = 'Toons'
QuestsRescueQuestAux = 'Rette:'
QuestsRescueNewNewbieQuestObjective = 'Helfe einem neuen Toon %s zu retten'
QuestsRescueOldNewbieQuestObjective = 'Helfe einem neuen Toon unter %(laffPoints)d Lachpunkten, %(objective)s zu retten'
QuestCogPartQuestCogPart = 'Bot Anzug Teil'
...
QuestsCogPartQuestDesc = 'einen Bot Anzug Teil'
QuestsCogPartQuestDescC = '%(count)s Bot Anzug Teile'
QuestsCogPartQuestDescI = 'einige Bot Anzug Teile'
...
QuestsDeliverGagQuestProgress = '%(progress)s von %(numGags)s geliefert'
QuestsDeliverGagQuestHeadline = 'ÜBERLIEFERE'
QuestsDeliverGagQuestToSCStringS = 'Ich muss %(gagName)s überliefern..'
QuestsDeliverGagQuestToSCStringP = 'Ich muss einige %(gagName)s überliefern.'
QuestsDeliverGagQuestSCString = 'Ich muss etwas überliefern..'
QuestsDeliverGagQuestString = 'Überliefere %s'
QuestsDeliverGagQuestStringLong = 'Überliefe %s zu _toNpcName_.'
QuestsDeliverGagQuestInstructions = 'Du kannst dir diesen Gag im Gagshop kaufen, sobald du dir ihn verdient hast.'
QuestsDeliverItemQuestProgress = ''
QuestsDeliverItemQuestHeadline = 'ÜBERLIEFERE'
QuestsDeliverItemQuestSCString = 'Ich muss %(article)s%(itemName)s überliefern.'
QuestsDeliverItemQuestString = 'Überliefere %s'
QuestsDeliverItemQuestStringLong = 'Überliefere %s zu _toNpcName_.'
QuestsVisitQuestProgress = ''
QuestsVisitQuestHeadline = 'BESUCHE'
QuestsVisitQuestStringShort = 'Besuche'
QuestsVisitQuestStringLong = 'Besuche _toNpcName_'
QuestsVisitQuestSeeSCString = 'Ich muss %s. besuchen.'
QuestsRecoverItemQuestProgress = '%(progress)s von %(numItems)s zurückgeholt'
QuestsRecoverItemQuestHeadline = 'HOLE ZURÜCK'
QuestsRecoverItemQuestSeeHQSCString = 'Ich muss einen ' + lHQOfficerM + ' sehen.'
...
QuestsRecoverItemQuestGoToHQSCString = 'Ich muss zu einem Toon HQ gehen.'
...
QuestsTrackChoiceQuestHeadline = 'ENTSCHEIDEN'
QuestsTrackChoiceQuestSCString = 'Ich muss mich zwischen %(trackA)s und %(trackB)s entscheiden.'
QuestsTrackChoiceQuestMaybeSCString = 'Vielleicht sollte ich %s. wählen...'
QuestsTrackChoiceQuestString = 'Wähle aus zwischen %(trackA)s und %(trackB)s'
QuestsFriendQuestHeadline = 'ANFREUNDEN'
QuestsFriendQuestSCString = 'Ich muss einen Freund machen.'
QuestsFriendQuestString = 'Mache einen Freund'
QuestsMailboxQuestHeadline = 'POST'
QuestsMailboxQuestSCString = 'Ich muss meine Post checken.'
QuestsMailboxQuestString = 'Checke deine Posts ab.'
QuestsPhoneQuestHeadline = 'KLARABELLA'
QuestsPhoneQuestSCString = 'Ich muss Klarabella anrufen.'
QuestsPhoneQuestString = 'Rufe Klarabella an'
#QuestsFriendNewbieQuestString = 'Make %d friends %d laff or less'
QuestsFriendNewbieQuestProgress = '%(progress)s von %(numFriends)s angefreundet'
QuestsFriendNewbieQuestObjective = 'Freunde dich mit %d neuen Toons an'
...
QuestsMinigameNewbieQuestString = '%d Minispiele'
QuestsMinigameNewbieQuestProgress = '%(progress)s von %(numMinigames)s gespielt'
QuestsMinigameNewbieQuestObjective = 'Spiele %d Minispiele mit neuen Toons.'
QuestsMinigameNewbieQuestSCString = 'Ich muss Minispiele mit neuen Toons spielen.'
QuestsMinigameNewbieQuestCaption = 'Helfe einem neuen Toon unter %d Lachpunkten.'
QuestsMinigameNewbieQuestAux = 'Spiele:'
QuestsMaxHpReward = 'Deine Lachpunkte wurden um %s erhöht.'
QuestsMaxHpRewardPoster = 'Belohnung: %s Lachpunkte'
QuestsMoneyRewardSingular = 'Du bekommst 1 jellybean.'
QuestsMoneyRewardPlural = 'Du bekommst %s jellybeans.'
QuestsMoneyRewardPosterSingular = 'Belohnung: 1 jellybean'
QuestsMoneyRewardPosterPlural = 'Belohnung: %s jellybeans'
QuestsMaxMoneyRewardSingular = 'Du kannst nun 1 jellybean tragen.'
QuestsMaxMoneyRewardPlural = 'Du kannst nun %s jellybeans tragen.'
QuestsMaxMoneyRewardPosterSingular = 'Belohnung: Trage 1 jellybean'
QuestsMaxMoneyRewardPosterPlural = 'Belohnung: Trage %s jellybeans'
...
QuestsMaxQuestCarryReward = 'Du kannst nun an %s ToonTasks zur selben Zeit arbeiten.'
QuestsMaxQuestCarryRewardPoster = 'Belohnung: Trage %s ToonTasks'
QuestsTeleportReward = 'Du hast nun Teleportzugang zu %s.'
QuestsTeleportRewardPoster = 'Belohnung: Teleport Zugang zu %s'
QuestsTrackTrainingReward = 'Du kannst nun für "%s" Gags trainieren.'
QuestsTrackTrainingRewardPoster = 'Belohnung: Gag Training'
QuestsTrackProgressReward = 'Du hast nun das Trainingsbild %(frameNum)s von ganzen %(trackName)s Trainingsbildern.'
QuestsTrackProgressRewardPoster = 'Belohnung: "%(trackName)s" Trainingsbild %(frameNum)s'
QuestsTrackCompleteReward = 'Du kannst nun "%s" Gags tragen und benutzen.'
QuestsTrackCompleteRewardPoster = 'Belohnung: Abschluss %s Track Training.'
QuestsClothingTicketReward = 'Du kannst deine Kleider wechseln.'
QuestsClothingTicketRewardPoster = 'Belohnung: Kleiderticket'
...
CashbotS = 'ein Schachermat'
SellbotS = 'ein Monetomat'
BossbotP = 'Chefomaten'
LawbotP = 'Rechtomaten'
CashbotP = 'Schachermaten'
SellbotP = 'Monetomaten'
BossbotSkelS = 'ein Chefomat Skelebot'
LawbotSkelS = 'ein Rechtomat Skelebot'
CashbotSkelS = 'ein Schachermat Skelebot'
SellbotSkelS = 'ein Monetomat Skelebot'
BossbotSkelP = 'Bossbot Skelecogs Skelebot'
LawbotSkelP = 'Lawbot Skelecogs Skelebot'
CashbotSkelP = 'Cashbot Skelecogs Skelebot'
SellbotSkelP = 'Sellbot Skelecogs Skelebot'
SkeleRevivePostFix = ' v2.0'
AvatarDetailPanelOK = lOK
AvatarDetailPanelCancel = lCancel
AvatarDetailPanelClose = lClose
AvatarDetailPanelLookup = 'Suche nach Details von %s.'
AvatarDetailPanelFailedLookup = 'Fehlgeschlagen, Details von %s zu bekommen.'
...
AvatarDetailPanelOnlinePlayer = 'Bezirk: %(district)s\nOrt: %(location)s\nSpieler: %(player)s'
AvatarDetailPanelOffline = 'Bezirk: offline\nOrt: offline'
AvatarShowPlayer = 'Zeige Spieler an'
OfflineLocation = 'Offline'
PlayerToonName = 'Toon: %(toonname)s'
PlayerShowToon = 'Zeige Toon'
PlayerPanelDetail = 'Spieler Details'
AvatarPanelFriends = 'Freunde'
AvatarPanelWhisper = 'Flüstern'
AvatarPanelSecrets = 'Geheime Freunde'
AvatarPanelGoTo = 'Gehe zu'
AvatarPanelPet = 'Zeige Doodle an'
AvatarPanelIgnore = 'Igonrieren'
AvatarPanelIgnoreCant = 'Okay'
AvatarPanelStopIgnoring = 'Ignorieren aufheben'
AvatarPanelReport = 'Melde'
AvatarPanelCogLevel = 'Level: %s'
AvatarPanelCogDetailClose = lClose
AvatarPanelDetail = 'Toon Details'
AvatarPanelGroupInvite = 'Einladung'
#AvatarPanelGroupRetract = 'Retract Invitation'
AvatarPanelGroupMember = 'Bereits in einer Gruppe'
AvatarPanelGroupMemberKick = 'Entfernen'
ReportPanelTitle = 'Melde einen Spieler'
ReportPanelBody = 'Dieses Feature wird einen Hilfebericht an einen Moderator schicken. Anstatt jemanden zu melden, könntest du eines der folgenden Sachen machen:\n\n  - Teleportier dich in einen anderen Bezirk\n  - Benutze den Ignoriere-Knopf, wenn du den Toon anklickst.\n\nWillst du wirklich %s an einen Moderator melden?'
ReportPanelBodyFriends = 'Dieses Feature wird einen Hilfebericht an einen Moderator schicken. Anstatt jemanden zu melden, könntest du eines der folgenden Sachen machen:\n\n  - Teleportier dich in einen anderen Bezirk\n  - Benutze den Ignoriere-Knopf, wenn du den Toon anklickst.\n\nWillst du wirklich %s an einen Moderator melden?\n\n(Dies wird auch eure Freundschaft beenden!)'
ReportPanelCategoryBody = 'Du bist kurz davor %s zu melden. Ein Moderazor wird die Meldung erhalten und sich umgehend um den Toon kümmern. Bitte wähle die Begründung aus, warum du %s meldest:'
ReportPanelBodyPlayer = 'An diesem Feature wird noch gearbeitet. In der Zwischenzeit kannst du folgendes machen:\n\n  - Geh zu DXD und beende eure Freundschaft dort.\n - Erzähle einem Elternteil was passiert ist.'
ReportPanelCategoryLanguage = 'Unangemessene Sprache'
ReportPanelCategoryPii = 'Ausgeben/Fragen nach persönlichen Details'
ReportPanelCategoryRude = 'Gemeines Verhalten'
ReportPanelCategoryName = 'Unangemessener Name'
ReportPanelCategoryHacking = 'Hacken'
'''ReportPanelConfirmations = ('Du bist kurz davor zu Melden dass %s öbszöne oder sexuell explizite Sprache verwendet hat.', 'Du bist kurz davor zu melden dass %s als Unsicher gilt, indem er eine Anforderung der Telefonnummer, Adresse, Name, E-Mail-Adresse,Passwort oder dem Account-Namen stellt.', 'Du bist kurz davor zu melden dass %s dich oder andere Leute im Spiel mobbt, belästigt oder mit extremen Verhalten versucht das Spielerlebniss zu zerstören.', "Du bist kurz davor zu melden dass %s sich einen Namen erstellt hat der nicht den Toontown Rewritten Nutzungbedingungen entspricht .", 'Du bist kurz davor zu melden dass %s das Spiel hackt bzw. das Spiel manipuliert oder eine Software von Drittanbietern benutzt.')
...
RewardPanelCongratsStrings = ['Yeah!', 'Congratulations!', 'Wow!', 'Cool!', 'Awesome!', 'Toon-tastic!']
...
CheesyEffectDescriptions = [('Normal Toon', 'you will be normal'), ('Big head', 'you will have a big head'), ('Small head', 'you will have a small head'), ('Big legs', 'you will have big legs'), ('Small legs', 'you will have small legs'), ('Big toon', 'you will be a little bigger'), ('Small toon', 'you will be a little smaller'), ('Flat portrait', 'you will be two-dimensional'), ('Flat profile', 'you will be two-dimensional'), ('Transparent', 'you will be transparent'), ('No color', 'you will be colorless'), ('Invisible toon', 'you will be invisible')]
...
DownloadForceAcknowledgeVerbList = ['painted', 'unpacked', 'unfolded', 'drawn', 'inflated', 'built']
...
TeaserTakeTask = 'To take these Toontasks'
...
LauncherPhaseNames = {0: 'Initialization', 1: 'Panda', 2: 'Engine', 3: 'Make-A-Toon', 3.5: 'Toontorial', 4: 'Playground', 5: 'Streets', 5.5: 'Estates', 6: 'Neighborhoods I', 7: Cog + ' Buildings', 8: 'Neighborhoods II', 9: Sellbot + ' HQ', 10: Cashbot + ' HQ', 11: Lawbot + ' HQ', 12: Bossbot + ' HQ', 13: 'Parties'}
...
FishTrophyNameDict = {0: 'Guppy', 1: 'Minnow', 2: 'Fish', 3: 'Flying Fish', 4: 'Shark', 5: 'Swordfish', 6: 'Killer Whale'}
...
NumToColor = ['White', 'Peach', 'Bright Red', 'Red', 'Maroon', 'Sienna', 'Brown', 'Tan', 'Coral', 'Orange', 'Yellow', 'Cream', 'Citrine', 'Lime', 'Sea Green', 'Green', 'Light Blue', 'Aqua', 'Blue', 'Periwinkle', 'Royal Blue', 'Slate Blue', 'Purple', 'Lavender', 'Pink', 'Plum', 'Black']
AnimalToSpecies = {'dog': 'Dog', 'cat': 'Cat', 'mouse': 'Mouse', 'horse': 'Horse', 'rabbit': 'Rabbit', 'duck': 'Duck', 'monkey': 'Monkey', 'bear': 'Bear', 'pig': 'Pig'}
...
CagedToonDrop = ["Great job!  You're wearing him down!", "Keep after him!  He's on the run!", 'You guys are doing great!', "Fantastic!  You've almost got him now!"]
...
WallpaperNames = {1000: 'Parchment', 1100: 'Milan', 1200: 'Dover', 1300: 'Victoria', 1400: 'Newport', 1500: 'Pastoral', 1600: 'Harlequin', 1700: 'Moon', 1800: 'Stars', 1900: 'Flowers', 2000: 'Spring Garden', 2100: 'Formal Garden', 2200: 'Race Day', 2300: 'Touchdown!', 2400: 'Cloud 9', 2500: 'Climbing Vine', 2600: 'Springtime', 2700: 'Kokeshi', 2800: 'Posies', 2900: 'Angel Fish', 3000: 'Bubbles', 3100: 'Bubbles', 3200: 'Go Fish', 3300: 'Stop Fish', 3400: 'Sea Horse', 3500: 'Sea Shells', 3600: 'Underwater', 3700: 'Boots', 3800: 'Cactus', 3900: 'Cowboy Hat', 10100: 'Cats', 10200: 'Bats', 11000: 'Snowflakes', 11100: 'Hollyleaf', 11200: 'Snowman', 12000: 'ValenToons', 12100: 'ValenToons', 12200: 'ValenToons', 12300: 'ValenToons', 13000: 'Shamrock', 13100: 'Shamrock', 13200: 'Rainbow', 13300: 'Shamrock'}
FlooringNames = {1000: 'Hardwood Floor', 1010: 'Carpet', 1020: 'Diamond Tile', 1030: 'Diamond Tile', 1040: 'Grass', 1050: 'Beige Bricks', 1060: 'Red Bricks', 1070: 'Square Tile', 1080: 'Stone', 1090: 'Boardwalk', 1100: 'Dirt', 1110: 'Wood Tile', 1120: 'Tile', 1130: 'Honeycomb', 1140: 'Water', 1150: 'Beach Tile', 1160: 'Beach Tile', 1170: 'Beach Tile', 1180: 'Beach Tile', 1190: 'Sand', 10000: 'Ice Cube', 10010: 'Igloo', 11000: 'Shamrock', 11010: 'Shamrock'}
MouldingNames = {1000: 'Knotty', 1010: 'Painted', 1020: 'Dental', 1030: 'Flowers', 1040: 'Flowers', 1050: 'Ladybug', 1060: 'ValenToons', 1070: 'Beach', 1080: 'Winter Lights 1', 1085: 'Winter Lights 2', 1090: 'Winter Lights 3', 1100: "ValenToon's Cupid", 1110: "ValenToon's Heart 1", 1120: "ValenToon's Heart 2"}
WainscotingNames = {1000: 'Painted', 1010: 'Wood Panel', 1020: 'Wood', 1030: 'ValenToons', 1040: 'Underwater'}
WindowViewNames = {10: 'Large Garden', 20: 'Wild Garden', 30: 'Greek Garden', 40: 'Cityscape', 50: 'Wild West', 60: 'Under the Sea', 70: 'Tropical Island', 80: 'Starry Night', 90: 'Tiki Pool', 100: 'Frozen Frontier', 110: 'Farm Country', 120: 'Native Camp', 130: 'Main Street'}
...
CatalogGoodbyeList = ['Bye now!', 'Call back soon!', 'Thanks for calling!', 'Ok, bye now!', 'Bye!']
...
CatalogAcceptNotReleased = 'This item needs to be available in your Cattlelog before you can take this item out of your mailbox.'
...
HDHelpDict = {'DoneMoving': 'Finish room decorating.', 'Attic': 'Show list of items in attic. The attic stores items that are not in your room.', 'Room': 'Show list of items in room. Useful for finding lost items.', 'Trash': 'Show items in trash. Oldest items are deleted after a while or when trash overflows.', 'ZoomIn': 'Get a closer view of room.', 'ZoomOut': 'Get a farther view of room.', 'SendToAttic': 'Send the current furniture item to attic for storage.', 'RotateLeft': 'Turn left.', 'RotateRight': 'Turn right.', 'DeleteEnter': 'Change to delete mode.', 'DeleteExit': 'Exit delete mode.', 'FurnitureItemPanelDelete': 'Send %s to trash.', 'FurnitureItemPanelAttic': 'Place %s in room.', 'FurnitureItemPanelRoom': 'Return %s to attic.', 'FurnitureItemPanelTrash': 'Return %s to attic.'}
...
LawbotBossTaunts = ['%s, I find you in contempt of court!', 'Objection sustained!', 'Strike that from the record.', 'Your appeal has been rejected. I sentence you to sadness!', 'Order in the court!']
...
WitnessToonJuryWeightBonusSingular = {6: 'This is a tough case. You seated %d Toon juror, so your evidence has a bonus weight of %d.', 7: 'This is a very tough case. You seated %d Toon juror, so your evidence has a bonus weight of %d.', 8: 'This is the toughest case. You seated %d Toon juror, so your evidence has a bonus weight of %d.'}
WitnessToonJuryWeightBonusPlural = {6: 'This is a tough case. You seated %d Toon jurors, so your evidence has a bonus weight of %d.', 7: 'This is a very tough case. You seated %d Toon jurors, so your evidence has a bonus weight of %d.', 8: 'This is the toughest case. You seated %d Toon jurors, so your evidence has a bonus weight of %d.'}
IssueSummons = 'Summon'
...
GardenTrophyNameDict = {0: 'Wheelbarrow', 1: 'Shovels', 2: 'Flower', 3: 'Watering Can', 4: 'Shark', 5: 'Swordfish', 6: 'Killer Whale'}
SkillTooLow = 'Skill\nToo Low'
NoGarden = 'No\nGarden'
...
GolfCourseNames = {0: 'Walk In The Par', 1: 'Hole Some Fun', 2: 'The Hole Kit And Caboodle', 3: 'No Nice-A-Tees', 4: 'Boardroom Bogey-Man', 5: 'Executive Unfairway'}
GolfHoleNames = {0: 'Whole In Won', 1: 'No Putts About It', 2: 'Down The Hatch', 3: 'Seeing Green', 4: 'Hot Links', 5: 'Peanut Putter', 6: 'Swing-A-Long', 7: 'Afternoon Tee', 8: 'Hole In Fun', 9: 'Rock And Roll In', 10: 'Bogey Nights', 11: 'Tea Off Time', 12: 'Holey Mackerel!', 13: 'One Little Birdie', 14: 'At The Drive In', 15: 'Swing Time', 16: 'Hole On The Range', 17: 'Second Wind', 18: 'Whole In Won-2', 19: 'No Putts About It-2', 20: 'Down The Hatch-2', 21: 'Seeing Green-2', 22: 'Hot Links-2', 23: 'Peanut Putter-2', 24: 'Swing-A-Long-2', 25: 'Afternoon Tee-2', 26: 'Hole In Fun-2', 27: 'Rock And Roll In-2', 28: 'Bogey Nights-2', 29: 'Tea Off Time-2', 30: 'Holey Mackerel!-2', 31: 'One Little Birdie-2', 32: 'At The Drive In-2', 33: 'Swing Time-2', 34: 'Hole On The Range-2', 35: 'Second Wind-2', 36: 'Cogwalk Falls', 37: 'Fore the Cause', 38: 'Oh the Irony', 39: 'Office Unfairway', 40: 'Corner Golffice', 41: 'Golfy Work', 42: 'No Nice-A-Tees', 43: 'Synergy Shuffle', 44: 'Gold in One'}
...
GolfShotDesc = {-4: GolfCondor, -3: GolfAlbatross, -2: GolfEagle, -1: GolfBirdie, 0: GolfPar, 1: GolfBogey, 2: GolfDoubleBogey, 3: GolfTripleBogey}
...
CheckersWhiteTurn = "Red's Turn"
CheckersBlackTurn = "Green's Turn"
CheckersColorWhite = 'You are Red'
CheckersColorBlack = 'You are Green'
CheckersObserver = 'You are Observing'
CheckersMustJump = 'You must Jump'
CheckersJumpAgain = 'Jump Again'
...
SillySurgeTerms = {1: 'Amusing Ascent!', 2: 'Silly Surge!', 3: 'Ridiculous Rise!', 4: 'Giggle Growth!', 5: 'Funny Fueling!', 6: 'Batty Boost!', 7: 'Crazy Climb!', 8: 'Jolly Jump!', 9: 'Loony Lift!', 10: 'Hilarity Hike!', 11: 'Insanity Increase!', 12: 'Cracked-Uptick!'}
InteractivePropTrackBonusTerms = {0: 'Super Toon-Up!', 1: '', 2: '', 3: '', 4: 'Super Throw!', 5: 'Super Squirt!', 6: ''}
